const var1Node = $('.cl_var1');
const var2Node = $('.cl_var2');
const var3Node = $('.cl_var3');
const var4Node = $('.cl_var4');
const var5Node = $('.cl_var5');
const var6Node = $('.cl_var6');
const speechNode = $('.cl_speech');

const btnCreate = $('.btn-create');
const btnReplace = $('.btn-replace');
const textNode = $('.cl_text');
